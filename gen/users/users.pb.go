...
type CreateOrderRequest struct {
	...
	DurationMin   int64                  `protobuf:"varint,6,opt,name=duration_min,json=durationMin,proto3" json:"duration_min,omitempty"` // время в минутах
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateOrderRequest) GetDurationMin() int64 {
	if x != nil {
