...
type CreateOrderRequest struct {
	...
	Duration_Mn   int64                  `protobuf:"varint,6,opt,name=duration_Mn,json=durationMn,proto3" json:"duration_Mn,omitempty"` // время в минутах
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateOrderRequest) GetDuration_Mn() int64 {
	if x != nil {
		return x.Duration_Mn
	}
	return 0
}
